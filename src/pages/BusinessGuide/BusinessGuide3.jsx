...
const BusinessGuide2 = () => {
	...
	return (
		<div className={styles.container}>
			<Helmet>
			{/* 필수 메타 */}
			<title>청주 센텀 푸르지오 자이 - 계약서류안내</title>
			<meta
				name="description"
				content="청주 센텀 푸르지오 자이 분양 계약을 위한 서류 안내. 신분증, 주민등록등본, 인감증명서 등 필수 제출서류와 준비 절차, 유의사항을 빠르고 정확하게 확인하세요."
			/>
			...
			<meta property="og:title" content="청주 센텀 푸르지오 자이 - 계약서류안내" />
			<meta
				property="og:description"
				content="청주 센텀 푸르지오 자이 계약서류 안내: 신분증, 주민등록등본, 인감증명서 등 필수 제출서류와 준비 절차, 유의사항을 확인하세요."
			/>
			...
			{/* SEO: 페이지 제목/설명 */}
			<h1 className={styles.screenReaderOnly}>청주 센텀 푸르지오 자이 - 계약서류안내</h1>
			<p className={styles.screenReaderOnly}>
			청주 센텀 푸르지오 자이 계약서류안내 페이지에서는 분양 당첨 후 필요한 서류를 정리해 드립니다.
			...
			<div>계약을 위한 첫 걸음</div>
			<div>청주 센텀 푸르지오 자이, 준비된 서류로 안심 계약하세요.</div>
			</div>
