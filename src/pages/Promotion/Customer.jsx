...
export default function Customer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://formspree.io/f/mldprrlj", {
        method: "POST",
  ...
  return (
    ...
    <>
      <Helmet>
        ...
        <title>청주 센텀 푸르지오 자이 - 관심고객등록</title>
        <meta
          name="description"
          content="청주 센텀 푸르지오 자이 관심고객 등록 시 모델하우스 방문 예약 알림, 위치 및 현장 정보, 분양 일정과 혜택을 가장 먼저 받아보실 수 있습니다."
        />
        ...
        <meta property="og:title" content="청주 센텀 푸르지오 자이 - 관심고객등록" />
        <meta
          property="og:description"
          content="관심고객 등록하고 청주 센텀 푸르지오 자이 모델하우스 오픈, 청약·계약 일정, 위치/현장 소식을 가장 먼저 받아보세요."
        />
        ...
        <meta name="twitter:title" content="청주 센텀 푸르지오 자이 - 관심고객등록" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebPage",
            name: "청주 센텀 푸르지오 자이 - 관심고객등록",
            url: "https://www.bunyang-114.com/Promotion/Customer",
            description:
              "청주 센텀 푸르지오 자이 관심고객 등록 시 모델하우스 방문 예약 알림과 위치/현장 정보, 분양 일정을 사전에 안내받을 수 있습니다.",
            primaryImageOfPage: {
              "@type": "ImageObject",
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>청주센텀푸르지오자이</h2>
