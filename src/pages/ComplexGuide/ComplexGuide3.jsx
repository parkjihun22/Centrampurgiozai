...
const ComplexGuide3 = () => {
  ...
  return (
    <div className={styles.container}>
      <Helmet>
        <title>청주 센텀 푸르지오 자이 - 커뮤니티</title>
        <meta
          name="description"
          content="청주 센텀 푸르지오 자이 커뮤니티 시설을 소개합니다. 피트니스센터, 실내골프연습장, GX룸, 독서실, 어린이집, 게스트하우스, 사우나 등 입주민의 생활 품격을 높이는 다양한 편의시설을 만나보세요."
        />
        ...
        <meta property="og:title" content="청주 센텀 푸르지오 자이 - 커뮤니티" />
        <meta
          property="og:description"
          content="청주 센텀 푸르지오 자이 커뮤니티 시설: 피트니스, 실내골프, 독서실, 어린이집, 게스트하우스, 사우나 등 입주민을 위한 다양한 생활 편의시설."
        />
      ...
      {/* SEO: 페이지 제목/설명 */}
      <h1 className={styles.screenReaderOnly}>청주 센텀 푸르지오 자이 - 커뮤니티</h1>
      <p className={styles.screenReaderOnly}>
        청주 센텀 푸르지오 자이의 커뮤니티 페이지에서는 단지 내 다양한 편의시설을 소개합니다.
      ...
      <div className={styles.textBox}>
        ...
        <div>청주 센텀 푸르지오 자이, 프리미엄 커뮤니티를 누리다</div>
      </div>
