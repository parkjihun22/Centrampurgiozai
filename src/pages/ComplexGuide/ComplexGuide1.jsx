...
const ComplexGuide1 = () => {
	...
	return (
		<div className={styles.container}>
			<Helmet>
			{/* 페이지별 메타 */}
			<title>청주 센텀 푸르지오 자이 - 단지배치도</title>
			<meta
				name="description"
				content="청주 센텀 푸르지오 자이 단지배치도를 통해 동 배치, 조경, 커뮤니티 시설, 주차·보행 동선 설계를 확인하세요. 남향 위주 배치와 넓은 동간거리로 쾌적한 생활을 제공합니다."
			/>
			...
			<meta property="og:title" content="청주 센텀 푸르지오 자이 - 단지배치도" />
			<meta
				property="og:description"
				content="청주 센텀 푸르지오 자이 단지배치도: 동 배치, 조경과 커뮤니티, 주차·보행 동선까지 생활 편의를 고려한 최적 설계를 한눈에."
			/>
			...
			<meta name="twitter:title" content="청주 센텀 푸르지오 자이 - 단지배치도" />
			<meta
				name="twitter:description"
				content="청주 센텀 푸르지오 자이 단지배치도: 조경·커뮤니티·주차·동선 등 쾌적한 단지 설계를 확인하세요."
			/>
			...
			<script type="application/ld+json">
				...
				"@type": "WebPage",
				name: "청주 센텀 푸르지오 자이 - 단지배치도",
				url: "https://www.bunyang-114.com/ComplexGuide/intro",
				description:
					"청주 센텀 푸르지오 자이 단지배치도: 각 동의 위치, 조경, 커뮤니티 시설, 주차·보행 동선 설계를 확인하세요.",
				primaryImageOfPage: {
					"@type": "ImageObject",
			...
			{/* SEO: 페이지 제목/설명 */}
			<h1 className={styles.screenReaderOnly}>청주 센텀 푸르지오 자이 - 단지배치도</h1>
			<p className={styles.screenReaderOnly}>
			단지 배치도 페이지는 청주 센텀 푸르지오 자이의 전체 단지 구성도를 제공합니다.
			아파트 단지 내 동 배치, 공용 커뮤니티, 조경 및 주차·보행 동선을 시각적으로 보여주어
			공간 배치를 명확히 이해할 수 있도록 돕습니다.
			</p>

			{/* 히어로 카피 */}
			<div className={styles.textBox}>
			<div>쾌적함을 설계한 배치</div>
			<div>청주 센텀 푸르지오 자이, 공원형 단지의 일상을 누리다</div>
			</div>
