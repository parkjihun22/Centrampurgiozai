...
import page1 from "../../assets/FloorPlan/FloorPlan3/unit_99a.jpg"
...
const FloorPlan3 = () => {
	const menuContents = [
		...
		{ title: "99A", url: "/FloorPlan/84A" },
		{ title: "114A", url: "/FloorPlan/84B" },
		// { title: "84D", url: "/FloorPlan/114A" },
	...
	return (
		<div className={styles.container}>
			...
			<div className={styles.textBox}>
				<div>사직1구역 최중심, 22개동 2,271세대</div>
				<div>청주 센텀 푸르지오 자이가 새로운 주거 표준을 제시합니다.</div>
			</div>
