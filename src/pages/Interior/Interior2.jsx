    ...
    <div className={styles.container}>
      ...
      <MenuBar contents={menuContents} />
        ...
        <h1 className={styles.screenReaderOnly}>
          청주 센텀 푸르지오 자이 - 84D 인테리어
        </h1>
        <p className={styles.screenReaderOnly}>
          청주 센텀 푸르지오 자이 84D 타입 인테리어 페이지에서는 세련된 공간 디자인과
        ...
        <div className={styles.textBox}>
          <div>일상이 더 넓어지는 84D</div>
          <div>청주 센텀 푸르지오 자이, 프리미엄 인테리어를 만나보세요.</div>
        </div>
      ...
      <img
				...
				src={page1}
				alt="청주센텀푸르지오자이 84D 인테리어 안내 이미지2"
