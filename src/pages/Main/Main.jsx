...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `22개동 2,271세대 랜드마크`,
    text2: `전용 59·84·99·114·145㎡ 다양 구성<br/>
            지하2~지상29층, 사직1구역 최중심`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `도심·광역 교통 프리미엄`,
    text2: `사직대로·직지대로·1·2순환로 인접<br/>
            청주IC·서청주IC·KTX/SRT 오송역 연계`,
  ...
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `자연·휴식 특화 환경`,
    text2: `무심천 산책로·사직/운천공원 인접<br/>
            단지 내 공원형 조경으로 힐링 라이프`,
      ...
      {!isMobile ? (
        ...
        <>
          ...
          <div className={styles.imageContainer}>
            ...
            <div className={styles.mainImageTextSub}>
              대우건설·GS건설의 <span className={styles.highlightText}>신뢰와 가치가 돋보이는</span>{" "}
              <span className={styles.greyText}>브랜드 프리미엄</span>
            </div>
            <div className={styles.mainImageTitleBox}>
              <div className={styles.mainImageText}>원도심 최중심, 미래 프리미엄의 시작</div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 청주 도시철도 2호선(트램 예정)과 직주근접 교통망으로 편리한 광역 이동성<br />
                  - 서남부종합스포츠타운 개발, 사직·성안지구 생활권과 맞닿은 풍부한 생활 인프라<br />
                  - 단지 인근 신설 초·중학교(예정)와 충북 명문학군으로 누리는 우수한 교육환경<br />
                  - 무심천·체육공원·도심 녹지축과 연계된 쾌적한 주거환경<br />
                  - 대단지 브랜드타운 프리미엄, 총 2,271세대 중 일반분양 1,538세대 랜드마크
                </div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/mldprrlj"
              method="POST"
            >
              <label htmlFor="name">
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.container1}>
            ...
            <div className={styles.text3}>
              - 청주 도시철도 직주근접 교통망으로 편리한 광역 이동성<br />
              - 사직·성안지구 생활권과 맞닿은 풍부한 생활 인프라<br />
              - 단지 인근 신설 초·중학교(예정)와 우수한 교육환경<br />
              - 무심천·체육공원·도심 녹지축과 연계된 쾌적한 주거환경<br />
              - 대단지 브랜드타운 프리미엄, 총일반분양 1,538세대 랜드마크
            </div>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 청주센텀푸르지오자이에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="청주센텀푸르지오자이 모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
