...
const ComplexGuide1 = () => {
  ...
  return (
    <div className={styles.container}>
      <Helmet>
        <title>청주 센텀 푸르지오 자이 - 청약안내</title>
        <meta
          name="description"
          content="청주 센텀 푸르지오 자이 청약안내를 한눈에 확인하세요. 특별공급, 1·2순위 청약 일정, 자격요건, 필요서류 및 절차를 상세히 안내합니다."
        />
      ...
      <p className={styles.screenReaderOnly}>
        청주 센텀 푸르지오 자이 청약안내 페이지에서는 특별공급 및 1·2순위 청약 일정,
        신청 자격 요건, 필요 서류와 청약 절차를 확인할 수 있습니다.
        인터넷 청약을 통해 간편하고 신속하게 신청 가능하며,
        청약 전 필수 정보를 사전에 숙지하여 당첨 기회를 놓치지 마세요.
      </p>

      {/* 히어로 카피 */}
      <div className={styles.textBox}>
        <div>청약 절차와 일정을 확인하세요</div>
        <div>청주 센텀 푸르지오 자이 프리미엄 라이프의 기회</div>
      </div>
      ...
      <img
        ...
        src={page1}
        alt="청주 센텀 푸르지오 자이 - 청약안내문 -image1"
