...
const ComplexGuide1 = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <Helmet>
        <title>청주 센텀 푸르지오 자이 - 모집공고 안내</title>
        <meta
          name="description"
          content="청주 센텀 푸르지오 자이 모집공고를 한눈에 확인하세요. 공급 세대수·공급 면적·분양가, 청약 일정·자격, 당첨자 발표·계약 절차 및 유의사항을 안내합니다."
        />
      ...
      <h1 className={styles.screenReaderOnly}>
        청주 센텀 푸르지오 자이 - 모집공고안내
      </h1>
      <p className={styles.screenReaderOnly}>
        청주 센텀 푸르지오 자이 모집공고는 분양 전 단계에서 가장 중요한 공식 안내문입니다.
        이 페이지에서는 공급 세대수와 공급 면적, 분양가, 청약 자격 요건과 접수 일정,
